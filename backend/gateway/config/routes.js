module.exports = [
  ...
  { prefix: '/api/raw-deptA', target: process.env.DEPT_A_URL || 'http://localhost:3001', stripPrefix: true },
  { prefix: '/api/raw-deptB', target: process.env.DEPT_B_URL || 'http://localhost:3002', stripPrefix: true },
  { prefix: '/api/raw-deptC', target: process.env.DEPT_C_URL || 'http://localhost:3003', stripPrefix: true },
